...
export class CreatePokerTables1590173887373 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "poker_player" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "initialElo" integer NOT NULL, "turn" boolean NOT NULL, "hand" integer array NOT NULL, "stack" integer NOT NULL, "bigBlind" boolean NOT NULL, "bet" integer NULL, "outcome" character varying NULL, "finalElo" integer NULL, "nextHand" boolean NULL, "rematchRequested" boolean NULL, CONSTRAINT "PK_057079c8296e4e7244748c15c1f" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "poker_match" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "room" character varying NOT NULL, "smallBlind" integer NOT NULL, "bigBlind" integer NOT NULL, "cards" integer array NOT NULL, "minRaise" integer NOT NULL, "boardState" integer array NOT NULL, "handComplete" boolean NOT NULL, "handsPlayed" integer NOT NULL, "player1Id" integer, "player2Id" integer, CONSTRAINT "REL_4dcd3109bfffb5fb142e6ef39d" UNIQUE ("player1Id"), CONSTRAINT "REL_3e9741b99022b9b94452ec3f47" UNIQUE ("player2Id"), CONSTRAINT "PK_2e20538eb5937322a81d81563d5" PRIMARY KEY ("id"))`, undefined);
